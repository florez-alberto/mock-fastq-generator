"""Integration tests verifying generated FASTQ compatibility with third-party tools (e.g. fastp)."""
...
class TestFastpIntegration:
    ...
    def test_fastp_low_quality_filtering(self, tmp_path: Path) -> None:
        ...
        assert failed_due_to_quality == 100, "fastp did not attribute failures to low quality"
    ...
    def test_fastp_high_quality_passes(self, tmp_path: Path) -> None:
        ...
        assert passed_reads == 100, f"fastp surprisingly filtered {100 - passed_reads} high-quality reads"
